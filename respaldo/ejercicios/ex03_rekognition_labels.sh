...
aws rekognition detect-labels --image-bytes fileb://data/imagenes/ciudad.jpg --min-confidence 80 --max-labels 10 --region us-east-1
...
aws rekognition detect-faces --image-bytes fileb://data/imagenes/equipo.jpg --attributes ALL --region us-east-1
